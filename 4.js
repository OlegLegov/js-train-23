...
class Letter {
  ...
  constructor(title, text) {
    this.title = title; // Назва листа
    this.text = text; // Текстовий вміст листа
  }
}
...
class Picture {
  ...
  constructor(title, size) {
    this.title = title; // Назва зображення
    this.size = size; // Розмір зображення
  }
}
...
class Movie {
  ...
  constructor(title, duration) {
    this.title = title; // Назва відеофільму
    this.duration = duration; // Тривалість відеофільму
  }
}
...
class Portfolio {
  ...
  constructor() {
    this.elements = []; // Список об'єктів в портфоліо, початкове значення пустий масив
  }
  ...
  // Метод readLetter приймає letter та виводить в консоль
  readLetter(letter) {
    console.log(
  ...
  // Метод readPicture приймає picture та виводить в консоль
  readPicture(picture) {
    console.log(`Картина: ${picture.title}, Розмір: ${picture.size} KB`);
  }

  // Метод readMovie приймає movie та виводить в консоль
  readMovie(movie) {
    console.log(`Фільм: ${movie.title}, Тривалість: ${movie.duration} хвилин`);
  }

  // Метод readElements читає інформацію про всі об'єкти в портфоліо
  readElements() {
