...
class TeaMaker {
  ...
  // Метод для приготування чаю, що викликає всі кроки по черзі
  makeTea() {
    this.boilWater();
    this.addTeaLeaves();
    this.steepTea();
  ...
  // Метод для кип'ятіння води
  boilWater() {
    console.log("Кип'ятимо воду....");
  }

  // Метод для додавання чайних листків
  addTeaLeaves() {
    console.log("Додаємо чайні листки....");
  }

  // Метод для заварювання чаю
  steepTea() {
    console.log("Заварюємо чай....");
  }

  // Метод для переливання чаю в чашку
  pourIntoCup() {
    console.log("Переливаємо чай в чашку....");
  }

  // Метод для додавання інгредієнтів, який залишається пустим і може бути перевизначений у підкласах
  addCondiments() {
    // Пустий метод для перевизначення у підкласах
  }

  // Метод для подачі чаю
  serveTea() {
...
class GreenTeaMaker extends TeaMaker {
  ...
  // Перевизначений метод для додавання інгредієнтів для зеленого чаю
  addCondiments() {
...
class BlackTeaMaker extends TeaMaker {
  ...
  // Перевизначений метод для додавання інгредієнтів для чорного чаю
  addCondiments() {
